...
function Navbar({handleInput, handleSearch}) {
    return (
        <div className='wrapper ml-5'>
            <div className='search_box'>
                ...
                <input type="text" id="limpiar_input" className="input_search" placeholder="Qué estas buscando?" onChange={(e)=> handleInput(e)}/>
            </div>
        </div>
    );
}
